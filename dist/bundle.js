...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#app {\n  width: 50%;\n  height: 50%;\n  background-color: rgb(181 211 201);\n  font-size: 100px;\n}\n", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,UAAU;EACV,WAAW;EACX,kCAAkC;EAClC,gBAAgB;AAClB","sourcesContent":["#app {\n  width: 50%;\n  height: 50%;\n  background-color: rgb(181 211 201);\n  font-size: 100px;\n}\n"],"sourceRoot":""}]);
// Exports
...
const test = async () => {
  try {
    ...
    const res = await axios__WEBPACK_IMPORTED_MODULE_0__.get('https://api.github.com/users/chiefmikey');
